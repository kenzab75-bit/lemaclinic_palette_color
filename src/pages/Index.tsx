      ...
      <section id="histoire" className="relative py-section bg-gradient-to-b from-[#0E1217] via-[#151A20] to-[#0B0E13] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <div className="text-center mb-20">
            <h1 className="text-5xl font-bold text-[#E6E8EB] text-center drop-shadow-md">
              Mon Histoire
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            <div className="rounded-3xl p-8 bg-gradient-to-b from-[#16212F] via-[#1C2A3A] to-[#0D141D] shadow-[0_8px_30px_rgba(0,0,0,0.45)] text-[#E6E8EB]">
